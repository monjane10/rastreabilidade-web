        ...
        <div className="w-full max-w-5xl flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
          ...
          <section className="md:w-1/2 space-y-3">
            ...
            <p className="text-sm md:text-[15px] text-slate-600 leading-relaxed">
              Escolha como pretende aceder à plataforma. Consumidores podem
              verificar a origem e o historial dos produtos através do QR Code.
              Unidades industriais, estabelecimentos comerciais e entidades
              fiscalizadoras utilizam o acesso interno para registar e acompanhar
              os lotes processados.
            </p>
            <p className="text-[11px] text-slate-500">
              Esta aplicação é um protótipo funcional de apoio à transparência e
              segurança alimentar.
            </p>
          </section>
          ...
          <section className="md:w-1/2">
            <div className="w-full max-w-md mx-auto space-y-4">
              ...
              >
                <div className="flex items-center gap-4">
                  {/* Ícone utilizador institucional */}
